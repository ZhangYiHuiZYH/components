	...
	chplayer.prototype = {
		...
		*/
		timeButtonMouseDown: function() {
			...
			var timePrompt = function(time) {
				...
				var promptObj = {
					title: thisTemp.formatTime(time,true),
			...
			var timeBoBgmousemove = function(event) {
				...
				var buttonPromptObj = {
					title: thisTemp.formatTime(eventTime,true),
					x: eventX,
					y: timeBoBgXY['y']
				};
				thisTemp.promptShow(false, buttonPromptObj);
		...
		*/
		timeTextHandler: function() { //显示时间/总时间
			...
			this.CB['timeText'].innerHTML = this.formatTime(time,true) + ' / ' + this.formatTime(duration,true);
